...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Dubeucoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Dubeu.com", "dnsseed.Dubeu.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"Dubeu.com", "testnet-seed.Dubeu.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Dubeucoin is probably already running."), addrBind.ToString().c_str());
        else
